...
const Viper = () => {
  ...
  const abilities = [
    "Compact GoBilda Frame.",
    "Specimen and Sample Scoring Capabilities.",
    "Precise Claw to Claw Transfer.",
  ];

  return (
    <section id="viper" className="relative overflow-hidden pt-16 md:pt-20 lg:pt-28">
